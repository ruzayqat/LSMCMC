...
| | |
|:--:|:--:|
| ![Linear Data RMSE Comparison](paper_figures/ldata_compare_rmse.png) | ![Linear Data V1 Fields](paper_figures/ldata_v1_fields.png) |
| RMSE comparison: V1 vs V2 vs LETKF | V1 analysis fields at selected cycles |

*Additional timeseries figures are generated by `generate_paper_figures.py` after running the experiment.*
...
| | |
|:--:|:--:|
| ![Twin RMSE Comparison](paper_figures/nltwin_compare_rmse.png) | ![Twin V1 Fields](paper_figures/nltwin_v1_fields.png) |
| RMSE comparison: V1 vs V2 vs LETKF | V1 analysis fields at selected cycles |
