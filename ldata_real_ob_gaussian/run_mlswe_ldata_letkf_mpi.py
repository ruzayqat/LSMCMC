#!/usr/bin/env python
"""
run_mlswe_letkf_mpi.py
=======================
Multiprocessing-parallelised LETKF for the 3-layer multi-layer shallow-water
model (MLSWE) with real drifter observations from the NOAA Global Drifter
Program.
...
def _da_chunk_worker(args):
    ...
    xens_local = letkf_update_mlswe_mpi(
...
def main():
    ...
    print("=" * 64)
    print("  MLSWE LETKF - Multiprocessing-parallelised (3-layer)")
