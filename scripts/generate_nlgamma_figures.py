...
BASEDIR = os.path.dirname(_HERE)          # repository root
...
def generate_mcmc_diagnostics(v1_data, truth_raw):
    ...
    # ── Load V1 config ──
    cfg_v1 = os.path.join(BASEDIR, 'nldata_synth_ob_cauchy', 'example_input_nldata_cauchy_v1.yml')
    ...
    # ── Load V2 config ──
    cfg_v2 = os.path.join(BASEDIR, 'nldata_synth_ob_cauchy',
                          'example_input_nldata_cauchy_v2.yml')
